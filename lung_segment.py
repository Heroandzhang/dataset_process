...
if __name__ == '__main__':
    ...
    ###写入DICOM文件的路径
    origin_path = '/home/horan/our_luna/dicom'
    save_path='/home/horan/our_luna/seg_lung_DSB'
    img_save_path='/home/horan/our_luna/seg_img_DSB/'
    ...
    print(len(origin_path),'origin_path')
    ...
    for i in range(len(dirlist)):
        ...
        # print(dcm_dir[30:],'dcm_dir[14:]')
        # if len(dcm_dir[30:]) > 2:
        #     a, b = os.path.split(dcm_dir[30:])
        #     c = a + '_' + b
        #     print(a,b,c,'aabbbcccccc')
        #     save_mhd_dir = os.path.join(save_path, "{}.mhd".format(str(c)))
        #     print(save_mhd_dir,'111')
        # else:
        #     save_mhd_dir = os.path.join(save_path, "{}.mhd".format(dcm_dir[30:]))
        #     print(save_mhd_dir)
        # print(save_mhd_dir, 'save_mhd_dir')  ###保存文件
        ...
        for i in range(lung_mask.shape[0]):
            print('dcm_dir[30:]',dcm_dir[27:])
            arr = lung_mask[i, :, :]  # 获得第i张的单一数组type 'numpy.ndarray'
            img_save_dir = os.path.join(img_save_path, dcm_dir[27:])
