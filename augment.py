...
if __name__ == '__main__':
    # 读取BMP文件
    data_path = '/home/Chen_hongyu/lung_nodule_dataset/zhr_img/imgs'
    output_path = '/home/Chen_hongyu/lung_nodule_dataset/zhr_img/augment_img_horizontal_vertical'
    ...
    for filename in os.listdir(data_path):
        ...
        # 读取csv
        csv_dir = '/home/Chen_hongyu/lung_nodule_dataset/zhr_img/image_annotation_diameter.csv'
        annos_all = pd.read_csv(csv_dir)
        annos = annos_all[annos_all['pid'] == filename]
        temp_annos = []
        labels = []
        if len(annos) > 0:
        ...
        sample, bboxes = augment(sample=imgs, bboxes=labels, do_flip=True)
        # a = sample[0,0,:,:]
        idx = 0
        for i in lines:
